    ...
    <div className="space-y-16">
      ...
      <section className="space-y-6 animate-fade-in" style={{ animationDelay: '0.1s' }}>
        ...
        <div className="grid md:grid-cols-2 gap-6 relative">
          <div className="bg-surface/40 backdrop-blur-md p-8 rounded-2xl border border-border/60 hover:border-accent/30 transition-all duration-500 shadow-sm">
            ...
            <p className="font-light text-text-primary/85 leading-relaxed whitespace-pre-wrap text-sm sm:text-base">
              {elegy.pastSelf}
            </p>
          </div>
          <div className="bg-surface/40 backdrop-blur-md p-8 rounded-2xl border border-border/60 hover:border-accent/30 transition-all duration-500 shadow-sm">
      ...
      <section className="space-y-8 animate-fade-in" style={{ animationDelay: '0.3s' }}>
        ...
        <div className="px-4 md:px-12 py-10 relative bg-surface/20 rounded-3xl border border-accent/20 backdrop-blur-md">
          <div className="absolute top-2 left-4 text-accent/15 font-serif text-8xl leading-none select-none">“</div>
          ...
          <div className="absolute bottom-2 right-4 text-accent/15 font-serif text-8xl leading-none rotate-180 select-none">“</div>
        </div>
      </section>
      ...
      <section className="space-y-6 animate-fade-in" style={{ animationDelay: '0.5s' }}>
        ...
        <div className="p-8 md:p-12 bg-gradient-to-b from-surface/70 to-surface/30 backdrop-blur-md rounded-3xl border border-border/60 shadow-[0_10px_30px_rgba(0,0,0,0.2)]">
          <p className="font-sans font-light text-base md:text-lg leading-relaxed text-text-primary/90 whitespace-pre-wrap">
            {elegy.mirrorText}
          </p>
        </div>
      </section>
