...
export default function RegisterPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-background text-text-primary relative overflow-hidden selection:bg-accent/30 py-16">
      ...
      {/* Brand Header Link */}
      <Link href="/" className="font-serif text-3xl tracking-[0.3em] text-text-primary hover:text-accent transition-colors mb-8">
        ELEGY
      </Link>
      ...
      <div className="w-full max-w-md bg-surface/50 backdrop-blur-xl p-8 sm:p-10 rounded-3xl border border-border/70 shadow-[0_10px_40px_rgba(0,0,0,0.4)] animate-fade-in relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-text-muted font-light text-sm">Mulai ruang aman untuk refleksimu.</p>
        </div>
        <RegisterForm />
      </div>

      <p className="text-xs text-text-muted/60 font-mono mt-10">
